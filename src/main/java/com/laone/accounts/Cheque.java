...
public class Cheque extends Account
{
    ...
    {
        return "Cheque= " + "accountID: " + getAccountID() + '\'' + ", balance: " + getBalance() + ", branch: " + getBranch() + '\''  + "jointCustomer=" + jointCustomer.getCustomerID() + ", businessCustomer=" + businessCustomer.getCustomerID() + ", individualCustomer=" + individualCustomer.getCustomerID() + '}';
    }
        ...
        if (conn != null) {
            try {
                PreparedStatement stmt = conn.prepareStatement(
                        "INSERT INTO cheque (accountID, balance, branch, JCustomerID, BCustomerID, ICustomerID) VALUES (?, ?, ? ,? ,? ,?)"
                );
    ...
    public boolean deposit(double amount) {
        ...
        try (Connection conn = DBConnector.connect();
             PreparedStatement stmt = conn.prepareStatement(
                     "UPDATE cheque SET balance = ? WHERE accountID = ?")) {
