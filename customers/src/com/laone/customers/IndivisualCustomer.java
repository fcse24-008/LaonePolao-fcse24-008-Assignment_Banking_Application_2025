...
public class IndividualCustomer extends Customer
{
    ...
    public String toString() {
                                 return "IndividualCustomer = " + "customerID: " + getCustomerID() + '\'' + ", firstname: " + getFirstname() + '\'' + ", lastname: " + getLastname() + '\'' + ", contact: " + getContact() + '\'' + ", nationalID: " + getNationalID() + '\'' + ", gender: " + getGender() + '}';
                             }
        ...
        if (conn != null) {
            try {
                PreparedStatement stmt = conn.prepareStatement(
                        "INSERT INTO individual_customer (customerID, firstname, lastname , gender, contact, nationalID, pin) VALUES (?, ?, ?, ?, ?, ?, ?)"
                );
